# -*- coding: utf-8 -*-
"""
Created on Fri Feb 26 21:18:53 2021
...
flags.DEFINE_string('output','./data/video/output.avi', 'path to output video')
...
def main(_argv):
    ...
    #chepaixinxi = {}
    sxPara = [[(31.88888888888889, -25801.222222222223), 826, 835, 539, 826],[(-1.5294117647058822, 1246.5882352941176), 462, 275, 540, 826]]
    bmxPara = [[1130, 12, 493, 403]]
    while True:
        _, img = vid.read()
        # print(img.shape)
        if img is None:
